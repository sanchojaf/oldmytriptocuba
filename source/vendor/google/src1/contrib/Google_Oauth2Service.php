...
class Google_Oauth2Service extends Google_Service {
  ...
  public function __construct(Google_Client $client) {
    /*self::$servicePath = '';
    self::$version = 'v2';
    self::$serviceName = 'oauth2';*/

    $client->addService('oauth2', 'v2');
    self::$userinfo = new Google_UserinfoServiceResource($this, 'oauth2', 'userinfo', json_decode('{"methods": {"get": {"path": "oauth2/v2/userinfo", "scopes": ["https://www.googleapis.com/auth/userinfo.email", "https://www.googleapis.com/auth/userinfo.profile"], "id": "oauth2.userinfo.get", "httpMethod": "GET", "response": {"$ref": "Userinfo"}}}}', true));
    self::$userinfo_v2_me = new Google_UserinfoV2MeServiceResource($this, 'oauth2', 'me', json_decode('{"methods": {"get": {"path": "userinfo/v2/me", "scopes": ["https://www.googleapis.com/auth/userinfo.email", "https://www.googleapis.com/auth/userinfo.profile"], "id": "oauth2.userinfo.v2.me.get", "httpMethod": "GET", "response": {"$ref": "Userinfo"}}}}', true));
  }
  
  public static function setAuth(Google_Client $client) {
    /* self::$servicePath = '';
    self::$version = 'v2';
    self::$serviceName = 'oauth2';*/
