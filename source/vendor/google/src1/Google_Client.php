...
class Google_Client {
  ...
  public function __construct($config = array()) {
   ...
   public static function setAuth($config = array()) {
    global $apiConfig;
    $apiConfig = array_merge($apiConfig, $config);
    self::$cache = new $apiConfig['cacheClass']();
    self::$auth = new $apiConfig['authClass']();
  ...
  public function addService($service, $version = false) {
    ...
    if (isset($apiConfig['services'][$service])) {
      ...
      self::$services[$service] = array_merge(self::$services[$service], $apiConfig['services'][$service]);
    }
  }
   ...
   * @visible For Testing
   */
  public static function prepareService() {
    $service = array();
    $scopes = array();
    if (self::$scopes) {
      $scopes = self::$scopes;
   ...
   * successful.
   */
  public static function verifyIdToken($token = null) {
   ...
   * @return void
   */
  public static function setAssertionCredentials(Google_AssertionCredentials $creds) {
   ...
   * @experimental
   */
  public static function setUseObjects($useObjects) {
    global $apiConfig;
