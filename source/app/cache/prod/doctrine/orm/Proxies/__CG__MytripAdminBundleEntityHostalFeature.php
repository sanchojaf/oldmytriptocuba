 ...
 */
class HostalFeature extends \Mytrip\AdminBundle\Entity\HostalFeature implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\HostalFeature' . "\0" . 'hostalFeatureId', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\HostalFeature' . "\0" . 'createdDate', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\HostalFeature' . "\0" . 'hostal', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\HostalFeature' . "\0" . 'feature');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (HostalFeature $proxy) {
    ...
    public function getHostalFeatureId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getHostalFeatureId();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getHostalFeatureId', array());

        return parent::getHostalFeatureId();
    }
