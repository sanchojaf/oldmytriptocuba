 ...
 */
class HostalImage extends \Mytrip\AdminBundle\Entity\HostalImage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\HostalImage' . "\0" . 'hostalImageId', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\HostalImage' . "\0" . 'image', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\HostalImage' . "\0" . 'createdDate', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\HostalImage' . "\0" . 'hostal');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (HostalImage $proxy) {
    ...
    public function getHostalImageId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getHostalImageId();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getHostalImageId', array());

        return parent::getHostalImageId();
    }
