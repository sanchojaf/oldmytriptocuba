 ...
 */
class Destination extends \Mytrip\AdminBundle\Entity\Destination implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\Destination' . "\0" . 'destinationId', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\Destination' . "\0" . 'name', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\Destination' . "\0" . 'url', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\Destination' . "\0" . 'video', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\Destination' . "\0" . 'latitude', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\Destination' . "\0" . 'longitude', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\Destination' . "\0" . 'createdDate', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\Destination' . "\0" . 'modifyDate', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\Destination' . "\0" . 'status', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\Destination' . "\0" . 'country', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\Destination' . "\0" . 'province', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\Destination' . "\0" . 'tripadvisor');
        }
    ...
    public function getDestinationId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getDestinationId();
        }
