 ...
 */
class DestinationFeature extends \Mytrip\AdminBundle\Entity\DestinationFeature implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\DestinationFeature' . "\0" . 'distinationFeatureId', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\DestinationFeature' . "\0" . 'createdDate', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\DestinationFeature' . "\0" . 'destination', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\DestinationFeature' . "\0" . 'feature');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DestinationFeature $proxy) {
    ...
    public function getDistinationFeatureId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getDistinationFeatureId();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDistinationFeatureId', array());

        return parent::getDistinationFeatureId();
    }
