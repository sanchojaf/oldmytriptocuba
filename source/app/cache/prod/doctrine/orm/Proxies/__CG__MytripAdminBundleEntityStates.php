 ...
 */
class States extends \Mytrip\AdminBundle\Entity\States implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\States' . "\0" . 'sid', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\States' . "\0" . 'cid', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\States' . "\0" . 'state', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\States' . "\0" . 'code');
        }
