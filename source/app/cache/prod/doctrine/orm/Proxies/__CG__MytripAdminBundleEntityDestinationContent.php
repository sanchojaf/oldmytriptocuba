 ...
 */
class DestinationContent extends \Mytrip\AdminBundle\Entity\DestinationContent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\DestinationContent' . "\0" . 'destinationContentId', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\DestinationContent' . "\0" . 'name', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\DestinationContent' . "\0" . 'description', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\DestinationContent' . "\0" . 'locationDesc', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\DestinationContent' . "\0" . 'metaTitle', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\DestinationContent' . "\0" . 'metaDescription', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\DestinationContent' . "\0" . 'metaKeyword', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\DestinationContent' . "\0" . 'address', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\DestinationContent' . "\0" . 'city', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\DestinationContent' . "\0" . 'province', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\DestinationContent' . "\0" . 'country', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\DestinationContent' . "\0" . 'lan', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\DestinationContent' . "\0" . 'destination');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DestinationContent $proxy) {
    ...
    public function getDestinationContentId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getDestinationContentId();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDestinationContentId', array());

        return parent::getDestinationContentId();
    }
