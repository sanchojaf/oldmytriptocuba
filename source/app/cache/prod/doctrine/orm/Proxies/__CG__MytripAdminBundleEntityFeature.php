 ...
 */
class Feature extends \Mytrip\AdminBundle\Entity\Feature implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\Feature' . "\0" . 'featureId', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\Feature' . "\0" . 'feature', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\Feature' . "\0" . 'icon', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\Feature' . "\0" . 'createdDate');
        }
    ...
    public function getFeatureId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getFeatureId();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFeatureId', array());

        return parent::getFeatureId();
    }
