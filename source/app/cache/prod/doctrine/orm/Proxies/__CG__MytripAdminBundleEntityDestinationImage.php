 ...
 */
class DestinationImage extends \Mytrip\AdminBundle\Entity\DestinationImage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\DestinationImage' . "\0" . 'destinationImageId', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\DestinationImage' . "\0" . 'image', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\DestinationImage' . "\0" . 'createdDate', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\DestinationImage' . "\0" . 'destination');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DestinationImage $proxy) {
