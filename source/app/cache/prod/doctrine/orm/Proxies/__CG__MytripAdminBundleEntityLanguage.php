 ...
 */
class Language extends \Mytrip\AdminBundle\Entity\Language implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\Language' . "\0" . 'languageId', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\Language' . "\0" . 'language', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\Language' . "\0" . 'lanCode', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\Language' . "\0" . 'flag');
        }
    ...
    public function setLanCode($lanCode)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLanCode', array($lanCode));

        return parent::setLanCode($lanCode);
    }
    ...
    public function getLanCode()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLanCode', array());

        return parent::getLanCode();
    }
