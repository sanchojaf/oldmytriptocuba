 ...
 */
class SocialLink extends \Mytrip\AdminBundle\Entity\SocialLink implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\SocialLink' . "\0" . 'socialLinkId', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\SocialLink' . "\0" . 'site', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\SocialLink' . "\0" . 'link', '' . "\0" . 'Mytrip\\AdminBundle\\Entity\\SocialLink' . "\0" . 'createdDate');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SocialLink $proxy) {
    ...
    public function getSocialLinkId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getSocialLinkId();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSocialLinkId', array());

        return parent::getSocialLinkId();
    }
