...
$payment=$view['session']->get('payment');
  ...
  <tbody>
    ...
    <tr>
      <td colspan="2"><h1 style="margin: 0;font-size: 20px;font-weight: 300;">Thanks, <?php echo $booking_info[0]['firstname']." ".$booking_info[0]['lastname'];?>!  </h1>
        <p style="margin: 0;font-family: 'Yanone Kaffeesatz', sans-serif;color: #231F20;"><?php echo $view['translator']->trans('We thank you for making a reservation at');?> "<?php echo $hostal[0]['name'];?>" <?php echo $view['translator']->trans('and we have the pleasure of confirming your reservation details');?></p></td>
    </tr>
    <tr>
      ...
      <td align="left"><span class="border" style="border: 2px solid #0C7C87;width: 100%;display: table;border-radius: 5px;-moz-border-radius: 5px;-webkit-border-radius: 5px;">
        ...
        <?php if($booking_info[0]['province']!=''){?>
         ...
         <?php }?>
         <?php /*?>#<?php echo $booking_info[0]['address']." ".$booking_info[0]['address1'];?>, <?php echo $booking_info[0]['city'];?>, <?php echo $booking_info[0]['province']!=''?$province[0]['state']:'';?>, <?php echo $booking_info[0]['country']!=''?$country[0]['country']:'';?><?php */?>
         </p>
        </span><span class="border" style="border: 2px solid #0C7C87;width: 100%;display: table;border-radius: 5px;-moz-border-radius: 5px;-webkit-border-radius: 5px;">
   ...
   <tr>
    ...
    <tr>
      <td align="left" class="border" style=" width:30%; float:left;border: 2px solid #0C7C87;;display: table;border-radius: 5px;-moz-border-radius: 5px;-webkit-border-radius: 5px;"> 
        <h1 style="margin: 0;font-size: 20px;font-weight: 300;"><?php echo $view['translator']->trans('MADE PAYMENT');?>:</h1>
        <p style="margin: 0;font-family: 'Yanone Kaffeesatz', sans-serif;color: #231F20;"><?php echo $booking_transaction[0]['transactionAmount'];?>  <?php echo $booking_price[0]['conversionCurrency'];?>  </p>
     </td> 
        
        <td align="left" class="border" style="width:38%;float:left;margin:0 5px;border: 2px solid #0C7C87;display: table;border-radius: 5px;-moz-border-radius: 5px;-webkit-border-radius: 5px;"> 
        <h1 style="margin: 0;font-size: 20px;font-weight: 300;"><?php echo $view['translator']->trans('PENDING PAYMENT');?>:</h1>
        <p style="margin: 0;font-family: 'Yanone Kaffeesatz', sans-serif;color: #231F20;"><?php echo ((($booking_price[0]['conversionRate']*$booking_price[0]['totalPrice'])+($booking_price[0]['conversionRate']*$booking_price[0]['reservationCharge']))-$booking_transaction[0]['transactionAmount']);?>  <?php echo $booking_price[0]['conversionCurrency'];?></p>
     </td> 
        <td align="left" class="border" style="width:28%;float:left;border: 2px solid #0C7C87;display: table;border-radius: 5px;-moz-border-radius: 5px;-webkit-border-radius: 5px;"> 
        <h1 style="margin: 0;font-size: 20px;font-weight: 300;"><?php echo $view['translator']->trans('TOTAL PRICE');?>:</h1>
    ...
    <br><br><?php echo $view['translator']->trans('You have free cancellation until 30 days before arrival, the pre-paid value does not expire. Prepaid value can used to book at later time or other properties under the B&B category in Cuba');?>.
<br><br>
