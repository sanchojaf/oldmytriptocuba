...
$refund=$view['session']->get('refund');
...
$booking_cancel=$em->createQuery("SELECT d FROM MytripAdminBundle:BookingCancel d WHERE d.booking=".$bookingid)->getArrayResult();
...
<table width="600" cellpadding="0" cellspacing="0" border="0" class="contenttable" style="border-spacing: 5px;width: 640px;margin: 0px auto;padding: 15px 15px 140px 15px;background:#fff;">
  <tbody>
    <tr>
      <td><a href="<?php echo $url['url']; ?>"><img src="<?php echo $url['url'].$view['assets']->getUrl('img/emaillogo.png'); ?>" width="191" height="185" alt="logo" /></a></td>
    </tr>
     <tr>
      <td colspan="2"><h1 style="margin: 0;font-size: 20px;font-weight: 300;">Thanks, <?php echo $booking_info[0]['firstname']." ".$booking_info[0]['lastname'];?>!  </h1>
        <p style="margin: 0;font-family: 'Yanone Kaffeesatz', sans-serif;color: #231F20;"><?php echo $hostal[0]['name'];?>" <?php echo $view['translator']->trans('Reservation booking cancelled successfully');?>. <?php echo $view['translator']->trans('Cancel details:');?></p></td>
    </tr>
    <tr>
    ...
    <tr>
      <td align="left" class="border" style=" width:30%; float:left;border: 2px solid #0C7C87;;display: table;border-radius: 5px;-moz-border-radius: 5px;-webkit-border-radius: 5px;"> 
        <h1 style="margin: 0;font-size: 20px;font-weight: 300;"><?php echo $view['translator']->trans('Transaction Details');?>:</h1>
        <p style="margin: 0;font-family: 'Yanone Kaffeesatz', sans-serif;color: #231F20;"><?php echo $booking_cancel[0]['refundReferenceno']!=''?$booking_cancel[0]['refundReferenceno']:'-';?> </p>
     </td> 
        ...
        <h1 style="margin: 0;font-size: 20px;font-weight: 300;"><?php echo $view['translator']->trans('Payment Mode');?>:</h1>
        <p style="margin: 0;font-family: 'Yanone Kaffeesatz', sans-serif;color: #231F20;"><?php echo $booking_transaction[0]['paymentType'];?></p>
     </td> 
        ...
        <h1 style="margin: 0;font-size: 20px;font-weight: 300;"><?php echo $view['translator']->trans('Refund Amount');?>:</h1>
        <p style="margin: 0;font-family: 'Yanone Kaffeesatz', sans-serif;color: #231F20;"><?php echo $booking_cancel[0]['refundAmount'];?> <?php echo $booking_cancel[0]['refundCurrency'];?></p>
     </td>
    </tr>
    </table>
    </td>         
