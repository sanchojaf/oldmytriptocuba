...
<form action="<?php echo $view['router']->generate('mytrip_admin_deletehostal') ?>" id="myForm" method="post">
    <table class="gtable sortable">
		...
		foreach($pagination as $hostals){			
			...
			?>
      <tr >
       <td align="center"><input type="checkbox" name="action[]" rel="action" value="<?php echo $hostals->getHostalId(); ?>" /></td>
       <td align="center"><?php echo $i; ?></td>
       <td align="left"><?php echo $hostals->getName();?></td>       
       <td align="center"><?php echo $hostals->getStatus();?></td>
       <td align="center">
		<?php echo ($hostals->getStatus()=="Active" ? '<a href="'.$view['router']->generate('mytrip_admin_status',array('page'=>'hostal','status'=>'inactive','id'=>$hostals->getHostalId())).'" class="confirdel1" rel="Inactive">Click to Deactive</a>':'<a href="'.$view['router']->generate('mytrip_admin_status',array('page'=>'hostal','status'=>'active','id'=>$hostals->getHostalId())).'" class="confirdel1" rel="Active">Click to Active</a>'); ?></td> 
        <td align="center"><a href="<?php echo $view['router']->generate('mytrip_admin_banner',array('type'=>'hostal','id'=>$hostals->getHostalId()));?>"><img src="<?php echo $view['assets']->getUrl('img/icons/add.png');?>"/></a></td>  
        <td align="center"><a href="<?php echo $view['router']->generate('mytrip_admin_edithostal',array('id'=>$hostals->getHostalId(),'lan'=>'en'));?>"><img src="<?php echo $view['assets']->getUrl('img/icons/edit.png');?>"/></a></td>
        <td align="center"><a href="<?php echo $view['router']->generate('mytrip_admin_deletehostal',array('id'=>$hostals->getHostalId()));?>" class="confirdel"><img src="<?php echo $view['assets']->getUrl('img/icons/cross.png');?>"/></a></td>
      </tr>
      <?php $i++;
	  }
	  }?>
