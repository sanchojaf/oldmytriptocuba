...
<div id="content"  class="clearfix">
  <div class="container">
    <div align="right" style="padding: 10px 10px 0px;"><a href="<?php echo $view['router']->generate('mytrip_admin_hostal_cancel',array('id'=>$_REQUEST['hostalid']));?>" class="button">Back to Cancel Settings</a></div>
    <form action="" id="myForm" method="post">
    <fieldset>
      <legend><?php echo $hostal[0]['name'];?> - Edit Cancel settings</legend>
      <dl class="inline">
