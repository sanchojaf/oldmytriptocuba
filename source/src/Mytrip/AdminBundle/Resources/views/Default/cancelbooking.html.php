...
<div id="content" class="clearfix"> 
    ...
    <div class="btnlink"></div> 		
        <div class="titletag"><h1>Cancel Booking</h1></div>
    </div>
  <div class="tablefooter clearfix">
 <form name="searchfilters" action="" id="myForm1" method="post" style="width:950px;float:left;padding: 5px 10px;">  
		...
		?>
        <a href="<?php echo $view['router']->generate('mytrip_admin_cancel_booking');?>" class="button small" style="padding:3px 5px;">Cancel</a>
        <?php
		} ?></td>
        </tr></table></form>        
  </div>
<form action="" id="myForm" method="post">
    <table class="gtable sortable">
      ...
      <tr >
       ...
       <td align="center"><a href="<?php echo $view['router']->generate('mytrip_admin_viewbooking',array('id'=>$bookings->getBookingId(),'type'=>'cancel'));?>"><img src="<?php echo $view['assets']->getUrl('img/icons/view.png');?>"/></a></td>
      </tr>
      <?php $i++;
	  }
	  }?>
