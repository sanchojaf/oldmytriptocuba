...
<div id="content" class="clearfix"> 
    ...
    <div class="btnlink"><a href="<?php echo $view['router']->generate('mytrip_admin_add_story');?>" class="button">Add Story</a></div> 	
 ...
 <form name="searchfilters" action="" id="myForm1" method="post" style="width:800px;float:left;padding: 5px 10px;">  
		...
		?>
        <a href="<?php echo $view['router']->generate('mytrip_admin_list_story');?>" class="button small" style="padding:3px 5px;">Cancel</a>
        <?php
		} ?></td>
        </tr></table></form>        
  </div>
<form action="<?php echo $view['router']->generate('mytrip_admin_delete_story_multiple') ?>" id="myForm" method="post">
    <table class="gtable sortable">
      ...
      <tr >
       <td align="center"><input type="checkbox" name="action[]" rel="action" value="<?php echo $story->getStoryId(); ?>" /></td>
        ...
        <td align="left"><?php echo $story->getStatus();?></td> 
        
                           
        <td align="left">
		<?php echo ($story->getStatus()=="Active" ? '<a href="'.$view['router']->generate('mytrip_admin_status_story',array('page'=>'story','status'=>'inactive','id'=>$story->getStoryId())).'" class="confirdel1" rel="Inactive">Click to Deactive</a>':'<a href="'.$view['router']->generate('mytrip_admin_status_story',array('page'=>'story','status'=>'active','id'=>$story->getStoryId())).'" class="confirdel1" rel="Active">Click to Active</a>'); ?></td>       
       
 
 <td align="left"><a target="_blank" href="<?php echo $view['router']->generate('mytrip_admin_manage_banner_story'); ?>?id=<?php echo $story->getStoryId(); ?>" >Manage Banner</a></td> 
        
        <td align="center"><a href="<?php echo $view['router']->generate('mytrip_admin_edit_story',array('id'=>$story->getStoryId()));?>"><img src="<?php echo $view['assets']->getUrl('img/icons/edit.png');?>"/></a></td>
        
        <td align="center"><a href="<?php echo $view['router']->generate('mytrip_admin_delete_story',array('id'=>$story->getStoryId()));?>" class="confirdel"><img src="<?php echo $view['assets']->getUrl('img/icons/cross.png');?>"/></a></td>
      </tr>
      <?php $i++;
	  }
	  }?>
