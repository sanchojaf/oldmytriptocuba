...
class PurchaseExamplesController extends Controller
{
     ...
     *   name="mytrip_paypal_express_checkout_prepare_simple_purchase_doctrine_orm"
     * )
     * 
     * @Extra\Template("MytripPaypalExpressCheckoutBundle:PurchaseExamples:prepare.html.twig")
     */
     ...
     *   name="mytrip_paypal_express_checkout_prepare_simple_purchase_doctrine_mongo_odm"
     * )
     *
     * @Extra\Template("MytripPaypalExpressCheckoutBundle:PurchaseExamples:prepare.html.twig")
     */
    public function prepareSimplePurchaseAndDoctrineMongoOdmAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $storage = $this->getPayum()->getStorage('Mytrip\PaymentBundle\Document\PaymentDetails');
     ...
     *   name="mytrip_paypal_express_checkout_prepare_digital_goods_purchase"
     * )
     * 
     * @Extra\Template
     */
     ...
     *   name="mytrip_paypal_express_checkout_prepare_simple_purchase_with_custom_api"
     * )
     *
     * @Extra\Template
     */
     ...
     *   name="mytrip_paypal_express_checkout_prepare_purchase_with_ipn_enabled"
     * )
     *
     * @Extra\Template("MytripPaypalExpressCheckoutBundle:PurchaseExamples:prepare.html.twig")
     */
